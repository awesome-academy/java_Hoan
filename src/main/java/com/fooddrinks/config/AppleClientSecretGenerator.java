 ...
 *   app.apple.private-key   — PEM content of the .p8 key (PKCS8 EC key, no header line needed)
    ...
    public String generate() {
        ...
        try {
            ...
            throw new IllegalStateException(
                    ...
                    + "Verify that app.apple.private-key is a valid PKCS8 EC private key.", e);
        }
    }

    /**
     * Parses the PEM-encoded EC private key.
     * Accepts either raw base64 or a full PEM block (with -----BEGIN/END PRIVATE KEY----- headers).
     */
